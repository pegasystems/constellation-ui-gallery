...
> **Status legend:** blank = actively maintained in the gallery · **Deprecated** = still available, prefer OOB alternative · **Removed in next release** = OOB in Pega 26.1; will leave the gallery · **Limited** = supported only for narrow / partial use cases

| Component                                   | Short Description                                                                            | Status                  | Notes / reason                                                                  | Docs                                                                      |
| ------------------------------------------- | -------------------------------------------------------------------------------------------- | ----------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
...
| **Pega_Extensions_AutoSave**                | Automatically saves form data as the user types or changes fields.                           | Removed in next release | Available OOB in Pega 26.1                                                      | [Docs](./src/components/Pega_Extensions_AutoSave/Docs.mdx)                |
...
| **Pega_Extensions_BannerInput**             | Combines a banner with an input field for quick data entry.                                  | Deprecated              | Prefer instruction-text banners in Pega '26                                     | [Docs](./src/components/Pega_Extensions_BannerInput/Docs.mdx)             |
...
| **Pega_Extensions_CardGallery**             | Displays items in a card‑style gallery layout.                                               | Deprecated              | Prefer Insight-based gallery templates in Pega '26                              | [Docs](./src/components/Pega_Extensions_CardGallery/Docs.mdx)             |
...
| **Pega_Extensions_CaseReference**           | References a Pega case, showing key details.                                                 | Limited                 | Prefer OOB Case Reference except for current-case / custom-ID preview use cases | [Docs](./src/components/Pega_Extensions_CaseReference/Docs.mdx)           |
| **Pega_Extensions_ChatGenAI**               | Integrates generative AI chat into the application.                                          | Deprecated              | Prefer Pega Platform agent functionality                                        | [Docs](./src/components/Pega_Extensions_ChatGenAI/Docs.mdx)               |
...
| **Pega_Extensions_CPQTree**                 | Reads the CPQ Tree structure and displays it in Constellation.                               | Limited                 | Read-only; not full CPQ application support                                     | [Docs](./src/components/Pega_Extensions_CPQTree/Docs.mdx)                 |
| **Pega_Extensions_DateInput**               | Locale-specific calendar date input.                                                         | Removed in next release | Available OOB in Pega 26.1                                                      | [Docs](./src/components/Pega_Extensions_DateInput/Docs.mdx)               |
...
| **Pega_Extensions_JapaneseInput**           | Provides Japanese language input support.                                                    | Removed in next release | Available OOB in Pega 26.1                                                      | [Docs](./src/components/Pega_Extensions_JapaneseInput/Docs.mdx)           |
...
| **Pega_Extensions_LangSwitch**              | Language and timezone preference panel.                                                      | Deprecated              | Prefer language switch via the operator menu in Pega '26                        | [Docs](./src/components/Pega_Extensions_LangSwitch/Docs.mdx)              |
...
| **Pega_Extensions_MaskedInput**             | Input field with masking (e.g., phone, SSN).                                                 | Deprecated              | Prefer OOB formatted inputs on form fields in Pega '26                          | [Docs](./src/components/Pega_Extensions_MaskedInput/Docs.mdx)             |
...
| **Pega_Extensions_SecureRichText**          | Rich‑text editor with security controls.                                                     | Removed in next release | Available OOB in Pega 26.1 (can disable link/image insert)                      | [Docs](./src/components/Pega_Extensions_SecureRichText/Docs.mdx)          |
| **Pega_Extensions_Shortcuts**               | Provides keyboard shortcuts for quick actions.                                               | Deprecated              | Prefer the OOB Shortcuts widget in Pega '26                                     | [Docs](./src/components/Pega_Extensions_Shortcuts/Docs.mdx)               |
| **Pega_Extensions_SignatureCapture**        | Capture user signatures via touch or mouse.                                                  | Deprecated              | Prefer paragraph field as signature in Pega 26.1.2                              | [Docs](./src/components/Pega_Extensions_SignatureCapture/Docs.mdx)        |
...
| **Pega_Extensions_StatusBadge**             | Badge showing status with color coding.                                                      | Deprecated              | Prefer formatting a text field as status in an Insight                          | [Docs](./src/components/Pega_Extensions_StatusBadge/Docs.mdx)             |
