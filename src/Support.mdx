...
The project provides released version of the components for Pega Infinity 23.1, 24.1, 24.2, 25.1 and 26.1 releases but only the latest Pega Platform version (26.1) will be actively worked on.
