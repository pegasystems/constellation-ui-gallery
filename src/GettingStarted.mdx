...
For consistency, the Constellation DX component should reuse the components already provided by the Constellation component library available at [design.pega.com/develop](https://design.pega.com/develop).
