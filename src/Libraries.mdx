...
- **@pega/cosmos-xx** version 9.x for Pega 26.1
...
- **React** 18.x
- **Styled Components** 6.3.12 (exact version)

There has been issues with the Styled Components library using different versions within the same document (especially different major versions) as well as incompatibilities with libraries using React 18 and React 19.
...
For the documentation and developer experience, the **Storybook** library version 10.x is used.
