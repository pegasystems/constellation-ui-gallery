...
This component will use a case type to represent the tasks. The list of tasks is passed using a page list Data Page. The component supports the following features:
