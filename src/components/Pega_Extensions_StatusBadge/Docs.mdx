...
This component is **deprecated** and may be removed in a future release of the UI Gallery. You can format a text field as a status field in an Insight. Prefer the out-of-the-box functionality when possible.
