...
// interface for props
interface PegaExtensionsUploadComponentProps extends PConnFieldProps {
...
function PegaExtensionsUploadComponent(props: PegaExtensionsUploadComponentProps) {
...
export default withConfiguration(PegaExtensionsUploadComponent);
