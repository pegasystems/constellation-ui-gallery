...
export const useTreeBuilder = (
   ...
   */
  const processProductNode = useCallback(
    (item: any, currentPath: string, nodeId: string, childcases: Array<CustomTreeNode>) => {
   ...
   */
  const processGrandchildren = useCallback(
    (
      childcase: any,
      nodeId: string,
      currentPath: string,
   ...
   */
  const processChildNodes = useCallback(
    (
      children: any[],
      parentName: string,
      nodeId: string,
    ...
    [displayPropertyName, processGrandchildren],
  );
  ...
  const loadTree = useCallback(
    ...
    [childrenPropertyName, displayPropertyName, idPropertyName, getPConnect, processChildNodes, processProductNode],
  );
