...
import { PegaExtensionsActionButton } from './index';

export default {
  title: 'Fields/Action Button',
  argTypes: {
    getPConnect: {
      table: {
        disable: true,
  ...
  component: PegaExtensionsActionButton,
};
...
type Story = StoryObj<typeof PegaExtensionsActionButton>;
...
export const Default: Story = {
  render: (args) => {
    ...
    return <PegaExtensionsActionButton {...props} />;
  },
  args: {
    label: 'Launch',
