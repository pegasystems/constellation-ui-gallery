  ...
  return (
    ...
    >
      ...
      {(() => {
        ...
        return <polygon points={`${needleTip.x},${needleTip.y} ${bx1},${by1} ${bx2},${by2}`} fill='#1f2937' />;
      })()}
      ...
      {/* Center value */}
      <text x={cx} y={cy + 48} textAnchor='middle' fontSize='28' fontWeight='700' fill='#1f2937'>
        {value}
      ...
      <CardContent>
        <div style={{ position: 'relative' }}>
          ...
          <div style={{ position: 'absolute', top: 0, right: 0 }}>
            <Button variant='simple' label='Refresh' icon compact onClick={fetchData} disabled={loading}>
              <svg
                width='16'
                height='16'
                viewBox='0 0 24 24'
        ...
        {!loading && error && <Text variant='secondary'>{error}</Text>}
